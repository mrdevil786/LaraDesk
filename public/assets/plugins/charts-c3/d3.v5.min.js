...
(function(t, n) {
	...
	function o(t, n) {
		var e, r, o = t.length,
			...
			c = 0;
		if (null == n)
			for (; ++u < o;) isNaN(e = i(t[u])) || (c += (r = e - f) * (e - (f += r / ++a)));
		else
			for (; ++u < o;) isNaN(e = i(n(t[u], u, t))) || (c += (r = e - f) * (e - (f += r / ++a)));
		if (a > 1) return c / (a - 1)
	}
	...
	function Bt(t) {
		...
		var e, r, i = Gt(t.r),
			o = Gt(t.g),
			a = Gt(t.b),
			u = jt((.2225045 * i + .7168786 * o + .0606169 * a) / Ys);
	...
	function hn(t, n) {
		var e, r, i, o = al.lastIndex = ul.lastIndex = 0,
			a = -1,
			u = [],
			f = [];
		for (t += "", n += "";
			(e = al.exec(t)) && (r = ul.exec(n));)(i = r.index) > o && (i = n.slice(o, i), u[a] ? u[a] += i : u[++a] = i), (e = e[0]) === (r = r[0]) ? u[a] ? u[a] += r : u[++a] = r : (u[++a] = null, f.push({
			i: a,
			x: sn(e, r)
		})), o = ul.lastIndex;
	...
	function ee(n) {
		...
		function a() {
			...
			function o() {
				...
				p < c && (T *= -1, t = u, u = d, d = t, t = c, c = p, p = t, M in xh && Y.attr("cursor", mh[M = xh[M]])), g < h && (N *= -1, t = l, l = v, v = t, t = h, h = g, g = t, M in wh && Y.attr("cursor", mh[M = wh[M]])), S.selection && (k = S.selection), m && (c = k[0][0], p = k[1][0]), x && (h = k[0][1], g = k[1][1]), k[0][0] === c && k[0][1] === h && k[1][0] === p && k[1][1] === g || (S.selection = [
					[c, h],
					[p, g]
				], r.call(w), q.brush())
			}
			...
			if (s.apply(this, arguments)) {
				var u, c, l, h, d, p, v, g, y, _, b, m, x, w = this,
				...
				"overlay" === M ? S.selection = k = [
					[u = n === _h ? C : D[0], l = n === yh ? P : D[1]],
					[d = n === _h ? z : u, v = n === yh ? R : l]
				] : (u = k[0][0], l = k[0][1], d = k[1][0], v = k[1][1]), c = u, h = l, p = d, g = v;
				var O = ct(w).attr("pointer-events", "none"),
					Y = O.selectAll(".overlay").attr("cursor", mh[M]);
				if (t.event.touches) O.on("touchmove.brush", e, !0).on("touchend.brush touchcancel.brush", a, !0);
				else {
		...
		return e.move = function(t, e) {
			...
			return arguments.length ? (c = "function" == typeof t ? t : $n([
				[+t[0][0], +t[0][1]],
				[+t[1][0], +t[1][1]]
			]), e) : c
		}, e.filter = function(t) {
	...
	function ke(t) {
		function n(t, n) {
			...
			var r, i = [],
				...
				c = a <= 0,
				s = !1;
			for (t.charCodeAt(a - 1) === Fh && --a, t.charCodeAt(a - 1) === Ih && --a;
				(r = e()) !== Yh;) {
			...
			function n(t) {
				...
				if ("c" === g) x = b(t) + x, t = "";
					...
					if (t = b(Math.abs(t), p), v && (t = function(t) {
						...
						}(t)), w && 0 == +t && (w = !1), s = (w ? "(" === c ? c : "-" : "-" === c || "(" === c ? "" : c) + s, x = ("s" === g ? ld[8 + fd / 3] : "") + x + (w && "(" === c ? ")" : ""), m)
	...
	function hi(t, n) {
		...
		for (var f = 0, c = t.length; f < c; ++f)
			if (l = (s = t[f]).length)
				for (var s, l, h = s[l - 1], d = h[0], p = h[1] / 2 + $d, v = ap(p), g = np(p), y = 0; y < l; ++y, d = b, v = x, g = w, h = _) {
					var _ = s[y],
						b = _[0],
						m = _[1] / 2 + $d,
						x = ap(m),
		...
		return di(n, function(t) {
			...
			return {
				...
				point: function(l, h) {
					...
					if (!i && (c = f = v) && t.lineStart(), v !== f && (!(d = e(i, p)) || fi(i, d) || fi(p, d)) && (p[0] += Hd, p[1] += Hd, v = n(p[0], p[1])), v !== f) s = 0, v ? (t.lineStart(), d = e(p, i), t.point(d[0], d[1])) : (d = e(i, p), t.point(d[0], d[1]), t.lineEnd()), i = d;
					else if (u && i && a ^ v) {
						var y;
	...
	function yi(t, n, e, r) {
		...
		return function(a) {
			...
			function c(o, a) {
				var u = i(o, a);
				if (l && h.push([o, a]), m) d = o, p = a, v = u, m = !1, u && (w.lineStart(), w.point(o, a));
					...
					polygonEnd: function() {
						var n = function() {
								for (var n = 0, e = 0, i = l.length; e < i; ++e)
									for (var o, a, u = l[e], f = 1, c = u.length, s = u[0], h = s[0], d = s[1]; f < c; ++f) o = h, a = d, h = (s = u[f])[0], d = s[1], a <= r ? d > r && (h - o) * (r - a) > (d - a) * (t - o) && ++n : d <= r && (h - o) * (r - a) < (d - a) * (t - o) && --n;
								return n
							}(),
							e = x && n,
							i = (s = y(s)).length;
	...
	function Pi() {
		...
		var e, r, i, o, a, u, f, c, l, h, d, p, v = 10,
			g = v,
			y = 90,
			_ = 360,
			b = 2.5;
		return t.lines = function() {
			...
			return arguments.length ? (o = +n[0][0], i = +n[1][0], c = +n[0][1], f = +n[1][1], o > i && (n = o, o = i, i = n), c > f && (n = c, c = f, f = n), t.precision(b)) : [
				[o, c],
				[i, f]
			]
		}, t.extentMinor = function(n) {
			return arguments.length ? (r = +n[0][0], e = +n[1][0], u = +n[0][1], a = +n[1][1], r > e && (n = r, r = e, e = n), u > a && (n = u, u = a, a = n), t.precision(b)) : [
				[r, u],
				[e, a]
			]
		}, t.step = function(n) {
			...
			function e(r, i, o, a, u, f, c, s, l, h, d, p, v, g) {
				...
				if (b > 4 * n && v--) {
					var m = a + h,
						...
						M = fp(m * m + x * x + w * w),
						A = dr(w /= M),
						T = Jd(Jd(w) - 1) < Hd || Jd(o - l) < Hd ? (o + l) / 2 : tp(x, m),
						N = t(T, A),
						S = N[0],
						E = N[1],
						k = S - r,
	...
	function uo(t) {
		...
		return n.stream = function(t) {
				...
				return arguments.length ? (N = null == t ? (T = a = u = f = null, zi) : yi(T = +t[0][0], a = +t[0][1], u = +t[1][0], f = +t[1][1]), r()) : null == T ? null : [
					[T, a],
					[u, f]
				]
			}, n.scale = function(t) {
	...
	function go(t) {
		...
		return o.scale = function(t) {
			...
			return arguments.length ? (null == t ? s = e = r = i = null : (s = +t[0][0], e = +t[0][1], r = +t[1][0], i = +t[1][1]), n()) : null == s ? null : [
				[s, e],
				[r, i]
			]
		}, n()
	...
	function Po(t, n) {
		var e, r, i, o, a, u = new Do(t),
			f = +t.value && (u.value = t.value),
			c = [u];
		for (null == n && (n = zo); e = c.pop();)
			if (f && (e.value = +e.data.value), (i = n(e.data)) && (a = i.length))
				for (e.children = new Array(a), o = a - 1; o >= 0; --o) c.push(r = e.children[o] = new Do(i[o])), r.parent = e, r.depth = e.depth + 1;
	...
	function Go(t) {
		...
		t: for (u = 3; u < i; ++u) {
			...
			for (r.previous = n, r.next = e, n.next = e.previous = e = r, o = Ho(n);
				(r = r.next) !== e;)(a = Ho(r)) < o && (n = r, o = a);
			e = n.next
		}
		for (n = [e._], r = e;
	...
	function Bc(t, n) {
		...
		for (rb = [], nb = new Array(t.length), tb = new _c, eb = new _c;;)
			if (i = K_, o && (!i || o[1] < i.y || o[1] === i.y && o[0] < i.x)) o[0] === e && o[1] === r || (Uc(o), e = o[0], r = o[1]), o = t.pop();
			else {
				if (!i) break;
				Dc(i.arc)
			}
		if (function() {
			...
			function(t, n, e, r) {
				var i, o, a, u, f, c, s, l, h, d, p, v, g = nb.length,
					y = !0;
				for (i = 0; i < g; ++i)
					if (o = nb[i]) {
			...
			var e, r = this._,
				...
				if (!(arguments.length < 2)) {
					...
					for (; ++o < a;)
						...
						for (e in r) r[e] = E(r[e], t.name, null);
					return this
				}
				for (; ++o < a;)
	...
	if (t.event = null, "undefined" != typeof document) {
		"onmouseenter" in document.documentElement || (xs = {
	...
	On.prototype = Yn.prototype = {
		...
		select: function(t) {
			...
			for (var r = this._groups, i = r.length, o = new Array(i), a = 0; a < i; ++a)
				for (var u, f, c = r[a], s = c.length, l = o[a] = new Array(s), h = 0; h < s; ++h)(u = c[h]) && (f = t.call(u, u.__data__, h, c)) && ("__data__" in u && (f.__data__ = u.__data__), l[h] = f, Pn(l[h], n, e, h, l, Ln(u, e)));
	...
	ft.prototype.interrupt = function(t) {
		...
		for (var r = this._groups, i = r.length, o = 0; o < i; ++o)
			for (var a, u = r[o], f = u.length, c = 0; c < f; ++c)(a = u[c]) && Pn(a, t, n, c, u, e || Vn(a, n));
	...
	id.copy = function() {
		var t, n, e = new He(this._x, this._y, this._x0, this._y0, this._x1, this._y1),
			r = this._root;
		if (!r) return e;
		...
		var r, i, o, a, u, f, c, s = this._x0,
			...
			p = [],
			v = this._root;
		for (v && p.push(new Be(v, s, l, h, d)), null == e ? e = 1 / 0 : (s = t - e, l = n - e, h = t + e, d = n + e, e *= e); f = p.pop();)
		...
		var n, e, r, i, o, a, u = [],
			f = this._root;
		for (f && u.push(new Be(f, this._x0, this._y0, this._x1, this._y1)); n = u.pop();)
	...
	var hd, dd, pd, vd, gd, yd, _d, bd, md, xd, wd, Md, Ad, Td, Nd, Sd, Ed, kd, Cd, Pd, zd, Rd, Ld, Dd, Ud, qd, Od, Yd, Bd, Fd, Id, jd = new sr,
		Hd = 1e-6,
		Xd = 1e-12,
		Gd = Math.PI,
		Vd = Gd / 2,
	...
	Kr.invert = Kr;
	var _p, bp, mp, xp, wp, Mp, Ap, Tp, Np, Sp, Ep, kp = cr(),
		Cp = di(function() {
			return !0
		}, function(t) {
			var n, e = NaN,
			...
			var i;
			if (null == t) i = e * Vd, r.point(-Gd, i), r.point(0, i), r.point(Gd, i), r.point(Gd, 0), r.point(Gd, -i), r.point(0, -i), r.point(-Gd, -i), r.point(-Gd, 0), r.point(-Gd, i);
	...
	var Bg = "%Y-%m-%dT%H:%M:%S.%LZ",
		Fg = Date.prototype.toISOString ? function(t) {
			return t.toISOString()
		} : t.utcFormat(Bg),
		Ig = +new Date("2000-01-01T00:00:00.000Z") ? function(t) {
			var n = new Date(t);
		...
		i_ = cf(r_),
		o_ = xl(Zt(300, .5, 0), Zt(-240, .5, 1)),
		a_ = xl(Zt(-100, .75, .35), Zt(80, 1.5, .8)),
		u_ = xl(Zt(260, .75, .35), Zt(80, 1.5, .8)),
		f_ = Zt(),
		c_ = Rt(),
		s_ = Math.PI / 3,
		l_ = 2 * Math.PI / 3,
	...
	Kf.prototype = {
		...
		lineEnd: function() {
			...
			if (e)
				if (this._line ? this._context.lineTo(t[0], n[0]) : this._context.moveTo(t[0], n[0]), 2 === e) this._context.lineTo(t[1], n[1]);
					...
					for (var r = fc(t), i = fc(n), o = 0, a = 1; a < e; ++o, ++a) this._context.bezierCurveTo(r[0][o], i[0][o], r[1][o], i[1][o], t[a], n[a]);
		...
		remove: function(t) {
			...
			var n, e, r, i = t.U,
				o = t.L,
				a = t.R;
			if (e = o ? a ? wc(a) : o : a, i ? i.L === t ? i.L = e : i.R = e : this._ = e, o && a ? (r = e.C, e.C = t.C, e.L = o, o.U = e, e !== a ? (i = e.U, e.U = t.U, t = e.R, i.L = t, e.R = a, a.U = e) : (e.U = i, i = e, t = e.R)) : (r = t.C, t = e), t && (t.U = i), !r)
				if (t && t.C) t.C = !1;
				else {
					do {
						if (t === this._) break;
		...
		triangles: function() {
			...
			return this.cells.forEach(function(e, r) {
				if (o = (i = e.halfedges).length)
					for (var i, o, a, u = e.site, f = -1, c = n[i[o - 1]], s = c.left === u ? c.right : c.left; ++f < o;) a = s, s = (c = n[i[f]]).left === u ? c.right : c.left, a && s && r < a.index && r < s.index && Oc(u, a, s) < 0 && t.push([u.data, a.data, s.data])
			}), t
		},
		links: function() {
	...
	jc.prototype = Ic.prototype, t.version = "5.5.0", t.bisect = Kc, t.bisectRight = Kc, t.bisectLeft = ts, t.ascending = n, t.bisector = e, t.cross = function(t, n, e) {
		...
		var e, r = t.length,
			...
			u = 0;
		if (null == n)
			for (; ++a < r;) isNaN(e = i(t[a])) ? --o : u += e;
		else
			for (; ++a < r;) isNaN(e = i(n(t[a], a, t))) ? --o : u += e;
		if (o) return u / o
		...
		var r, o = t.length,
			...
			u = [];
		if (null == e)
			for (; ++a < o;) isNaN(r = i(t[a])) || u.push(r);
		else
			for (; ++a < o;) isNaN(r = i(e(t[a], a, t))) || u.push(r);
		return v(u.sort(n), .5)
		...
		function t(t) {
			...
			for (c = -1; ++c < h;)
				for (l = c - 1; ++l < h;) {
					var A = _[l * h + c],
						T = _[c * h + l];
					(A.value || T.value) && g.push(A.value < T.value ? {
						source: T,
						target: A
					} : {
						source: A,
		...
		function n() {
			for (var t, n, r, f, c, s, l, h = i.length, d = 0; d < u; ++d)
				for (n = je(i, Ge, Ve).visitAfter(e), t = 0; t < h; ++t) r = i[t], s = o[r.index], l = s * s, f = r.x + r.vx, c = r.y + r.vy, n.visit(function(t, n, e, i, o) {
					var u = t.data,
						h = t.r,
						d = s + h;
		...
		function n(n) {
			for (var e = 0, r = t.length; e < d; ++e)
				for (var i, u, f, s, l, h, p, v = 0; v < r; ++v) u = (i = t[v]).source, s = (f = i.target).x + f.vx - u.x - u.vx || Oe(), l = f.y + f.vy - u.y - u.vy || Oe(), s *= h = ((h = Math.sqrt(s * s + l * l)) - a[v]) / h * n * o[v], l *= h, f.vx -= s * (p = c[v]), f.vy -= l * p, u.vx += s * (p = 1 - p), u.vy += l * p
		}
		...
		function i() {
			if (u)
				for (var n = 0, e = t.length; n < e; ++n) a[n] = +h(t[n], n, t)
		}
		var o, a, u, f, c, s = $e,
			l = function(t) {
		...
		return Td = Nd = null, yd === 1 / 0 || _d === 1 / 0 ? [
			[NaN, NaN],
			[NaN, NaN]
		] : [
			[yd, _d],
		...
		return t.invert = function(t) {
			...
			var e = f.scale(),
				r = +t[0],
				u = +t[1];
			return i = f.translate(t).clipExtent([
				[r - .455 * e, u - .238 * e],
				[r + .455 * e, u + .238 * e]
			]).stream(l), o = c.translate([r - .307 * e, u + .201 * e]).clipExtent([
				[r - .425 * e + Hd, u + .12 * e + Hd],
				[r - .214 * e - Hd, u + .234 * e - Hd]
			]).stream(l), a = s.translate([r - .205 * e, u + .212 * e]).clipExtent([
				[r - .214 * e + Hd, u + .166 * e + Hd],
				[r - .115 * e - Hd, u + .234 * e - Hd]
			]).stream(l), n()
		...
		return a = {
			...
			clipExtent: function(i) {
				return arguments.length ? (p = null == i ? (d = n = e = r = null, zi) : yi(d = +i[0][0], n = +i[0][1], e = +i[1][0], r = +i[1][1]), t()) : null == d ? null : [
					[d, n],
					[e, r]
				]
			},
		...
		function t(t) {
			var f = function(t) {
				for (var n, e, r, i, o, a = new ca(t, 0), u = [a]; n = u.pop();)
					if (r = n._.children)
						for (n.children = new Array(o = r.length), i = o - 1; i >= 0; --i) u.push(e = n.children[i] = new ca(r[i], i)), e.parent = n;
				return (a.parent = new ca(null, 0)).children = [a], a
			}(t);
			if (f.eachAfter(n), f.parent.m = -f.z, f.eachBefore(e), u) t.eachBefore(r);
			else {
				var c = t,
					s = t,
					l = t;
		...
		function t() {
			var t, c, s = +n.apply(this, arguments),
			...
			if (f || (f = t = oe()), l < s && (c = l, l = s, s = c), l > M_)
				if (p > N_ - M_) f.moveTo(l * __(h), l * x_(h)), f.arc(0, 0, l, h, d, !v), s > M_ && (f.moveTo(s * __(d), s * x_(d)), f.arc(0, 0, s, d, h, v));
				else {
					var g, y, _ = h,
						b = d,
						m = h,
		...
		function t(t) {
			var o, a, u = n.apply(this, arguments),
				f = t.length,
				c = u.length,
				s = new Array(c);
			for (o = 0; o < c; ++o) {
		...
		if (i) {
			n = null == n ? null : n + "";
			for (r in i)
				if ((e = i[r]).state > Ll && e.name === n) return new On([
					[t]
				], hh, n, +r)
		}
		return null
		...
		function h() {
			var n, i, o, u, f = a(this, arguments),
		...
		return n.transform = function(t, n) {
			...
			return arguments.length ? (y = "function" == typeof t ? t : Fc([
				[+t[0][0], +t[0][1]],
				[+t[1][0], +t[1][1]]
			]), n) : y
	...
	}, t.zoomTransform = jc, t.zoomIdentity = fb, Object.defineProperty(t, "__esModule", {
		value: !0
	})
});